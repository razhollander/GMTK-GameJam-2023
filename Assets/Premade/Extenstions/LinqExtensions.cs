...
using System.Collections.Generic;
  ...
  public static class LinqExtensions
  {
    ...
    /// <summary>Convert a colletion to a HashSet.</summary>
    /// <footer><a href="https://www.google.com/search?q=Sirenix.Utilities.LinqExtensions.ToHashSet">`LinqExtensions.ToHashSet` on google.com</a></footer>
    [Obsolete("Just write new HashSet<T>(source, comparer) instead - this extension is causing naming conflict issues in Unity 2021.2+ and will be removed in the future.", false)]
    ...
    {
      for (int i = 0; i < collectionsToMerge.Length; i++)
      {
